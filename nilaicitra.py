...
Original file is located at
    https://colab.research.google.com/drive/1uEOVDlVKqyWDhs3Yt_xhqh3RhTyW7S7X
"""
...
image1 = cv2.imread('panda.png')  # Masukkan nama file citra pertama di sini
image2 = cv2.imread('kelinci.png')  # Masukkan nama file citra kedua di sini
